...
const val RADIOBROWSER_AUTHORITY = "br.com.matuki.radiobrowser"
...
internal class AlbumArtContentProvider : ContentProvider() {
    ...
    companion object {
        ...
        fun mapUri(uri: Uri): Uri {
            ...
            val contentUri = Uri.Builder()
                ...
                .authority(RADIOBROWSER_AUTHORITY)
                .path(path)
                .build()
    ...
    override fun openFile(uri: Uri, mode: String): ParcelFileDescriptor? {
        ...
        Timber.d("AlbumArtContentProvider openFile remoteUri: $remoteUri")
